...
//BACKPORT    LogUtils.disableZkAndClientLoggers(LOG);
  }
...
//BACKPORT    Logger backupClientLogger = Logger.getLogger("org.apache.hadoop.hbase.backup");
    if (this.cmd.hasOption(OPTION_DEBUG)) {
//BACKPORT     backupClientLogger.setLevel(Level.DEBUG);
    } else {
//BACKPORT      backupClientLogger.setLevel(Level.INFO);
    }
